...
- **Truy vấn:** `index=botsv1 imreallynotbatman.com sourcetype=stream:http src_ip="23.22.63.114"`
  ...
  ![Video về dấu hiệu tấn công từ IP 23.22.63.114]([link-video-ở-đây](https://github.com/PhucsS24/Incident-handling-with-Splunk/blob/main/assets/images_phase1/video%202.gif))
